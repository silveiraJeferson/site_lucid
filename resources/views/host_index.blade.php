...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../public/vendor/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css">
        <link rel="stylesheet" href="../../public/vendor/chartist/css/chartist.min.css">
        <link rel="stylesheet" href="../../public/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css">
    ...
    <body class="theme-cyan">
            ...
            <nav class="navbar navbar-fixed-top">
                <div class="container-fluid">
                    ...
                    <div class="navbar-brand">
                        <a href="index.html"><img src="../../public/images/logo.svg" alt="Lucid Logo" class="img-responsive logo"></a>                
                    </div>
            ...
            <div id="left-sidebar" class="sidebar">
                <div class="sidebar-scroll">
                    <div class="user-account">
                        <img src="../../public/images/user.png" class="rounded-circle user-photo" alt="User Profile Picture">
                        <div class="dropdown">
                            <span>Welcome,</span>
                        ...
                        <div class="tab-pane p-l-15 p-r-15" id="Chat">
                            ...
                            <ul class="right_chat list-unstyled">
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="../../public/images/xs/avatar4.jpg" alt="">
                                            <div class="media-body">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="../../public/images/xs/avatar5.jpg" alt="">
                                            <div class="media-body">
                                ...
                                <li class="offline">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="../../public/images/xs/avatar2.jpg" alt="">
                                            <div class="media-body">
                                ...
                                <li class="offline">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="../../public/images/xs/avatar1.jpg" alt="">
                                            <div class="media-body">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="../../public/images/xs/avatar3.jpg" alt="">
                                            <div class="media-body">
                                    ...
                                    <div class="cwidget-scroll">
                                        <ul class="chat-widget m-r-5 clearfix">
                                            <li class="left float-left">
                                                <img src="../../public/images/xs/avatar2.jpg" class="rounded-circle" alt="">
                                                <div class="chat-info">       
                                                    <span class="message">Hello, John<br>What is the update on Project X?</span>
                                                </div>
                                            </li>
                                            <li class="right">
                                                <img src="../../public/images/xs/avatar1.jpg" class="rounded-circle" alt="">
                                                <div class="chat-info">
                                    ...
                                    <div class="timeline-item blue" date-is="19-04-2018 - Yesterday">
                                        ...
                                        <div class="msg">
                                            ...
                                            <div class="timeline_img m-b-20">
                                                <img class="w-25" src="../../public/images/blog/blog-page-4.jpg" alt="Awesome Image">
                                                <img class="w-25" src="../../public/images/blog/blog-page-2.jpg" alt="Awesome Image">
                                            </div>
                                            <a href="javascript:void(0);" class="m-r-20"><i class="icon-heart"></i> Like</a>
        ...
        <script src="../../public/bundles/chartist.bundle.js"></script>
        <script src="../../public/bundles/knob.bundle.js"></script> <!-- Jquery Knob-->
        <script src="../../public/vendor/toastr/toastr.js"></script>

        <script src="../../public/bundles/mainscripts.bundle.js"></script>
